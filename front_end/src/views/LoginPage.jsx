...
export default function LoginPage() {
  return (
    ...
    <div className="flex items-center justify-center w-full min-h-screen  px-4 sm:px-6 lg:px-8 background">

      {/* Div interne avec flex pour gérer la disposition des deux div enfants */}
      <div className="flex w-full h-[56rem] max-w-5xl bg-white" style={{  }}>

        {/* Div pour la partie de la page web (signup/login) */}
        <div className="w-1/2 mr-10 flex flex-col justify-center  ">
             <LoginForm />
        </div>
