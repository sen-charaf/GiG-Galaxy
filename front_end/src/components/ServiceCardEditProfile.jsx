...
import CarouselEditProfile from "./CarouselEditProfile";

import StarRate from "../assets/star.svg";
import { Link } from "react-router-dom";

function ServiceCardEditProfile() {
  const slides = [
  ...
  return (
    <>
      <div className="flex min-[1500px]:h-[25rem]  min-[1500px]:pt-[1rem]  w-[18rem] flex-col space-y-2 bg-white p-4 border rounded group hover:cursor-pointer">
        <CarouselEditProfile slides={slides} />
...
export default ServiceCardEditProfile;
