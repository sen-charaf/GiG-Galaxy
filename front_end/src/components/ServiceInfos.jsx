    ...
    <div className="w-full bg-white  border rounded pt-8 h-fit pb-5   ">
        ...
        <div className="flex flex-col w-24 justify-center items-center">
          ...
          <div className="text-sm text-zinc-600">
            ...
            <div className="font-bold text-center">
              {service.displayed_delivery_time}
            </div>
          </div>
        </div>
        <div className="flex flex-col w-24 justify-center items-center">
          ...
          <div className="text-sm text-zinc-600 ">
            Rating <div className="font-bold text-center">{service.rating}</div>
          </div>
        </div>
        <div className="flex flex-col w-24 justify-center items-center">
          ...
          <div className="text-sm text-zinc-600">
            Orderd by{" "}
            <div className="font-bold">{service.orders_num} people</div>
          </div>
        </div>
      </div>
      ...
      <div className="mx-4">
        ...
        <div className="flex space-x-2 mb-3 ">
          ...
          <div className="flex flex-col space-y-1">
            <div className="flex justify-between items-center">
              <div className="font-semibold ">{service.user.name}</div>
        ...
        <div className=" flex w-full justify-between items-center space-x-3 mt-7">
          <Link className="w-full h-full" to={"/seller_profile"}>
          ...
          <Link className="w-full h-full" to={"/chat"}>
            <button
